        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const myVisitor = (node) => {
                if (isJsScriptNode(node)) {
                    ...
                    if (src) {
                        features.push(new html_script_tag_1.ScannedScriptTagImport('html-script', src, document.sourceRangeForNode(node), document.sourceRangeForAttributeValue(node, 'src'), node, false));
                    }
                    else {
                        ...
                        features.push(new model_1.ScannedInlineDocument('js', contents, locationOffset, attachedCommentText, document.sourceRangeForNode(node), { language: 'html', node, containingDocument: document }));
                    }
                }
            };
