...
suite('Polymer2ElementScanner', () => {
    const analyzer = analyzer_1.Analyzer.createForDirectory(path.resolve(test_utils_1.fixtureDir, 'polymer2/'));
...
~`);
    ...
    test('uses @customElement jsdoc tag for tagName', () => __awaiter(this, void 0, void 0, function* () {
        const elements = yield getElements('test-element-19.js');
        const elementData = yield Promise.all(elements.map(getTestProps));
        chai_1.assert.deepEqual(elementData, [
            {
                tagName: 'test-element',
...
namespaced name.`,
    ...
    test('can infer properties assigned to in the constructor', () => __awaiter(this, void 0, void 0, function* () {
        const elements = yield getElements('test-element-16.js');
        ...
        chai_1.assert.containSubset([...element.properties.values()], [
            {
                name: 'foo',
                privacy: 'protected',
                description: 'This description lives in the constructor.',
