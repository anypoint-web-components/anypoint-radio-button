...
suite('BehaviorScanner', () => {
    ...
    suiteSetup(() => __awaiter(this, void 0, void 0, function* () {
        const { features } = yield test_utils_1.runScanner(analyzer_1.Analyzer.createForDirectory(test_utils_1.fixtureDir), new behavior_scanner_1.BehaviorScanner(), 'js-behaviors.js');
        behaviors = new Map();
        behaviorsList =
