...
suite('Polymer2ElementScanner - Vanilla Element Scanning', () => {
    ...
    suiteSetup(() => __awaiter(this, void 0, void 0, function* () {
        ...
        const { features } = yield test_utils_1.runScanner(analyzer, new class_scanner_1.ClassScanner(), 'vanilla-elements.js');
    ...
    test('Extracts attributes from observedAttributes', () => {
        ...
        chai_1.assert.containSubset(Array.from(element.attributes.values()), [
            ...
            },
            {
                description: '',
                name: 'foo',
                sourceRange: { start: { column: 14, line: 27 }, end: { column: 19, line: 27 } },
            },
            {
                description: '',
                name: 'bar',
                sourceRange: { start: { column: 21, line: 27 }, end: { column: 26, line: 27 } },
            }
        ]);
    });
