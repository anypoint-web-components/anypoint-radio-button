...
suite('PolymerCoreFeatureScanner', () => {
    ...
    `;
        const { features: untypedFeatures } = yield test_utils_1.runScannerOnContents(new polymer_core_feature_scanner_1.PolymerCoreFeatureScanner(), 'features.js', js);
    ...
    test('resolves the Polymer.Base class', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const analyzer = analyzer_1.Analyzer.createForDirectory(path.resolve(test_utils_1.fixtureDir, 'polymer-core-feature/'));
