...
suite('PackageUrlResolver', function () {
    suite('resolve', () => {
        ...
        test(`resolves sibling URLs to the component dir`, () => {
            ...
            chai_1.assert.equal(configured.resolve((test_utils_1.rootedFileUrl `1/bar/bar.html`)), test_utils_1.rootedFileUrl `1/2/components/bar/bar.html`);
        });
        test('resolves sibling with matching name prefix to component dir', () => {
            ...
            chai_1.assert.equal(configured.resolve(test_utils_1.rootedFileUrl `repos/iron-iconset-svg/foo.html`), test_utils_1.rootedFileUrl `repos/iron-icons/bower_components/iron-iconset-svg/foo.html`);
        });
        ...
        test('passes URLs with unknown hostnames through untouched', () => {
            ...
            chai_1.assert.equal(r.resolve(test_utils_1.packageRelativeUrl `//abc.xyz/foo.html`), test_utils_1.resolvedUrl `file://abc.xyz/foo.html`);
        });
