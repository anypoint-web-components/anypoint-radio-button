 ...
 */
export declare function getMixinApplications(document: JavaScriptDocument, node: babel.Node, docs: Annotation, warnings: Warning[], scope: Scope): Array<ScannedReference<'element-mixin'>>;
