...
export declare class ScannedNamespace implements Resolvable {
    ...
    constructor(name: string, description: string, summary: string, astNode: babel.Node, properties: Map<string, ScannedProperty>, jsdoc: JsDocAnnotation, sourceRange: SourceRange);
