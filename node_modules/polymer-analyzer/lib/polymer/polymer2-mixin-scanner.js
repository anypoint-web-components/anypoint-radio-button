        ...
        if (hasMixinFunctionDocTag(parentJsDocs)) {
            ...
            if (namespacedName) {
                this._currentMixin = new polymer_element_mixin_1.ScannedPolymerElementMixin({
                    ...
                    jsdoc: parentJsDocs,
                    mixins: jsdoc.getMixinApplications(this._document, node, parentJsDocs, this.warnings, path.scope),
                });
        ...
        if (hasMixinFunctionDocTag(nodeJsDocs)) {
            ...
            if (namespacedName) {
                this._currentMixin = new polymer_element_mixin_1.ScannedPolymerElementMixin({
                    ...
                    jsdoc: nodeJsDocs,
                    mixins: jsdoc.getMixinApplications(this._document, node, nodeJsDocs, this.warnings, path.scope)
                });
                this._currentMixinNode = node;
                this.mixins.push(this._currentMixin);
            }
            ...
            if (node.declarations.length === 1) {
                ...
                if (name) {
                    ...
                    mixin = new polymer_element_mixin_1.ScannedPolymerElementMixin({
                        ...
                        jsdoc: docs,
                        mixins: jsdoc.getMixinApplications(this._document, declaration, docs, this.warnings, path.scope)
                    });
                }
            }
            if (mixin) {
