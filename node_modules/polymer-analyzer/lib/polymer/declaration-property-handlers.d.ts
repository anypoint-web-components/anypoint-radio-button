...
export declare function getBehaviorReference(argNode: babel.Node, document: JavaScriptDocument, scope: Scope): Result<ScannedReference<'behavior'>, Warning>;
 ...
 */
export declare function declarationPropertyHandlers(declaration: ScannedPolymerElement, document: JavaScriptDocument, scope: Scope): PropertyHandlers;
