...
function getBehaviorReference(argNode, document, scope) {
    ...
    return {
        successful: true,
        value: new model_1.ScannedReference('behavior', behaviorName, document.sourceRangeForNode(argNode), argNode, scope)
    };
}
 ...
 */
function declarationPropertyHandlers(declaration, document, scope) {
    return {
        is(node) {
