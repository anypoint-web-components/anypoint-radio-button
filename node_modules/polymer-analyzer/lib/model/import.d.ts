...
export declare class ScannedImport implements Resolvable {
     ...
     */
    lazy: boolean;
    constructor(type: string, url: FileRelativeUrl | undefined, sourceRange: SourceRange | undefined, urlSourceRange: SourceRange | undefined, ast: any | null, lazy: boolean);
...
export declare class Import implements Feature {
    ...
    constructor(url: ResolvedUrl, originalUrl: FileRelativeUrl, type: string, document: Document, sourceRange: SourceRange | undefined, urlSourceRange: SourceRange | undefined, ast: any, warnings: Warning[], lazy: boolean);
    toString(): string;
}
