...
class Analyzer {
     ...
     */
    static createForDirectory(dirname) {
        return new Analyzer({
            urlLoader: new fs_url_loader_1.FSUrlLoader(dirname),
            urlResolver: new package_url_resolver_1.PackageUrlResolver({ packageDir: dirname })
        });
    }
    /**
    ...
    analyze(urls) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._analysisComplete = (() => __awaiter(this, void 0, void 0, function* () {
                ...
                return yield previousContext.analyze(uiUrls);
            }))();
