...
export declare class AnalysisContext {
    ...
    static getDefaultScanners(options: Options): Map<string, Scanner<any, any, any>[]>;
     ...
     */
    analyze(urls: PackageRelativeUrl[]): Promise<AnalysisContext>;
    /**
     ...
     */
    scan(resolvedUrl: ResolvedUrl): Promise<ScannedDocument>;
    /**
